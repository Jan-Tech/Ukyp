...
const MOCK_PROFESSIONALS = [
  { id: "1", user: { name: "Aýgül Meredowa" }, category: "DESIGN", city: "ASHGABAT", bio: "UI/UX dizaýner. 6 ýyl tejribe.", bioRu: "UI/UX дизайнер. 6 лет опыта.", hourlyRate: 80, yearsExp: 6, isVerified: true, isBoosted: true, avatarUrl: null, _count: { reviews: 12 }, avgRating: 4.8 },
  { id: "2", user: { name: "Serdar Oraz" }, category: "IT", city: "ASHGABAT", bio: "Full-stack developer. React, Node.js, PostgreSQL.", bioRu: "Full-stack разработчик. React, Node.js, PostgreSQL.", hourlyRate: 120, yearsExp: 4, isVerified: true, isBoosted: false, avatarUrl: null, _count: { reviews: 8 }, avgRating: 4.6 },
  { id: "3", user: { name: "Maral Amanowa" }, category: "EDUCATION", city: "TURKMENABAT", bio: "Matematika we fizika mugallymy. 10 ýyl tejribe.", bioRu: "Преподаватель математики и физики. 10 лет опыта.", hourlyRate: 40, yearsExp: 10, isVerified: false, isBoosted: false, avatarUrl: null, _count: { reviews: 25 }, avgRating: 5.0 },
  { id: "4", user: { name: "Batyr Hojayew" }, category: "CONSTRUCTION", city: "MARY", bio: "Gurluşyk inženeri. Ýaşaýyş jaý we söwda desgalary.", bioRu: "Инженер строитель. Жилые и коммерческие объекты.", hourlyRate: 60, yearsExp: 8, isVerified: true, isBoosted: false, avatarUrl: null, _count: { reviews: 5 }, avgRating: 4.2 },
  { id: "5", user: { name: "Ogulşat Durdyýewa" }, category: "MEDICINE", city: "ASHGABAT", bio: "Kardiolog. Klinik işi we maslahat berme.", bioRu: "Кардиолог. Клиническая практика и консультации.", hourlyRate: 100, yearsExp: 12, isVerified: true, isBoosted: false, avatarUrl: null, _count: { reviews: 30 }, avgRating: 4.9 },
  { id: "6", user: { name: "Azat Myradow" }, category: "ARCHITECTURE", city: "ASHGABAT", bio: "Arhitektor. Ýaşaýyş we täjirçilik taslamalary.", bioRu: "Архитектор. Жилые и коммерческие проекты.", hourlyRate: 90, yearsExp: 7, isVerified: false, isBoosted: true, avatarUrl: null, _count: { reviews: 9 }, avgRating: 4.5 },
];
